...
/*******************************************************************************************************
Plugin: DNHAdmin
Script: pdf-list-table-class.inc.php
Doel  : Klasse die de lijst met pdf kan renderen
Auteur: BugSlayer
*******************************************************************************************************/
 ...
 */
class DNHpdf_List_Table extends WP_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            ...
            'plural'    => 'pdf',    //plural name of the listed records
	...
	function column_id($item) {
        //Build row actions
        $actions = array(
            'edit'      => sprintf( '<a href="?page=%s&%s=%s">%s</a>'  ,'dnh_pdf_edit'  ,$this->_args['singular'], $item->ID, __( 'Edit' ) ),
            'delete'    => sprintf( '<a href="?page=%s&%s=%s">%s</a>','dnh_pdf_delete',$this->_args['singular'], $item->ID, __( 'Delete' ) ),
        );
