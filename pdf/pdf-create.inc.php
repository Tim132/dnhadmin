...
/*******************************************************************************************************
Plugin: DNHAdmin
Script: pdf-create.inc.php
Doel  : "Template" voor het toevoegen van een nieuwe pdf
Auteur: BugSlayer
*******************************************************************************************************/
?>
<div class="wrap">
	<h2>Nieuwe pdf</h2>
	<p>Nieuwe pdf aanmaken waarop transacties kunnen worden geboekt.</p>
	...
	<form method="post" action="admin-post.php"> 
		...
		<input type="hidden" name="action" value="dnh_save_pdf" />
		...
		<input type="submit" value="Nieuwe pdf toevoegen" class="button button-primary"/>
	</form>
</div>
